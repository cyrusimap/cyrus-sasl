...
* `FAQ from Sendmail <http://www.sendmail.org/~ca/email/auth.html>`_
...
* `Common Internet File System (CIFS) Technical Reference <http://www.snia.org/tech_activities/CIFS/CIFS-TR-1p00_FINAL.pdf>`_ (SMB/NTLM)
